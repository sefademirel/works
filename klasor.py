...
for folder in first_level_folders:
    ...
    # Ana klasörün içine bir metin dosyası oluştur
    text_file_path = os.path.join(folder_path, 'info.txt')
    with open(text_file_path, 'w') as f:
        f.write(f"Ana Klasör: {folder}")
...
for first_level in first_level_folders:
    ...
    for second_level in second_level_folders:
        ...
        # Her ikinci seviye klasörün içine bir metin dosyası oluştur
        text_file_path = os.path.join(second_level_path, 'info.txt')
        with open(text_file_path, 'w') as f:
